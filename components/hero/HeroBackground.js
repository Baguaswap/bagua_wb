// Fixed star/particle positions (not Math.random) so server and client
// render identically — no hydration mismatch, no per-render recompute.
const STARS = [
...
export default function HeroBackground() {
  return (
    <>
      {/* Deep layers — nebula, fog and light rays drift independently and
          very slowly for a sense of depth without ever being distracting. */}
      ...
      {/* Original brand glows, kept exactly as they were. */}
      ...
      {/* Grid — unchanged from the original Hero. */}
      ...
      {/* Fine grain — static, purely textural, costs nothing to animate
          since it doesn't. */}
