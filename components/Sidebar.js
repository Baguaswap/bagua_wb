...
// route: null berarti item ini belum punya halaman sendiri - tetap dibuka
// lewat popup (Launchpad -> LaunchMenu, sisanya -> ComingSoonModal) seperti
// sebelumnya, bukan dengan Link.
const NAV_ITEMS = [
      ...
      >
        ...
        {address && (
          <div className="mx-5 mb-4 flex items-center justify-between rounded-xl bg-bg-card card-border px-4 py-3">
            <div className="flex items-center gap-2">
              <div className="h-7 w-7 rounded-full bg-gradient-to-br from-accent-purple to-accent-violet" />
              <div>
